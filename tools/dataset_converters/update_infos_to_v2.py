...
def update_titan_m_infos(pkl_path, out_dir):
    print(f"{pkl_path} will be modified.")
    if out_dir in pkl_path:
        print(f"Warning, you may overwriting " f"the original data {pkl_path}.")
        time.sleep(5)
...
def update_hsl_infos(pkl_path, out_dir):
    ...
    if out_dir in pkl_path:
        print(f"Warning, you may overwriting " f"the original data {pkl_path}.")
        time.sleep(5)
    # METAINFO = {'classes': ('Ground', 'Grass', 'Building', 'Tree', 'Road')}
    METAINFO = {
        "classes": (
            "Building",
            "Road",
...
def update_sensaturban_infos(pkl_path, out_dir):
    print(f"{pkl_path} will be modified.")
    if out_dir in pkl_path:
        print(f"Warning, you may overwriting " f"the original data {pkl_path}.")
        time.sleep(5)
...
def update_pkl_infos(dataset, out_dir, pkl_path):
    ...
    elif dataset.lower() == "titan_m":
        update_titan_m_infos(pkl_path=pkl_path, out_dir=out_dir)
    elif dataset.lower() == "hsl":
        update_hsl_infos(pkl_path=pkl_path, out_dir=out_dir)
    elif dataset.lower() == "sensaturban":
        update_sensaturban_infos(pkl_path=pkl_path, out_dir=out_dir)
    else:
