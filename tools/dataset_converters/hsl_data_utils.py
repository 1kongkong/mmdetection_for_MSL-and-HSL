...
class HSLData(object):
    """Titan data.

    Generate HSL infos for outdoor_converter.
    ...
    def get_infos(self, has_label=True):
        ...
        pts_filename = osp.join(self.root_dir, 'hsl_data', f'{self.split}_point.npy')
        pts_semantic_mask_path = osp.join(self.root_dir, 'hsl_data', f'{self.split}_sem_label.npy')
